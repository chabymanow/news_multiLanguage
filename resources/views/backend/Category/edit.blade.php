                            ...
                            <div class="mb-8">
                                ...
                                @csrf
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="category_en" id="addCategoryEN" value="{{ $category->category_en }}" lenght="25">
                                        ...
                                        <input type="text" class="form-control" name="category_hun" id="addCategoryHU" value="{{ $category->category_hun }}" lenght="25">
                                        @error('category_hun')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror

                                        <div class="justify-content-md-end">
                                            <button type="submit" class="btn btn-xl btn-primary mt-3 me-md-2 mt-5" style="float:right;">Update category</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
