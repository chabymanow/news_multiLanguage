        ...
        <div class="row">
            <div class="col-md-12" style="background:#191c24;">
                <div class="col-md-6" style="margin: 0 auto;">
                    <div class="card">
                        <div class="card-header"><h1>Update district</h1>
                        <div class="card-body">
                            <div class="mb-8">
                                ...
                                @csrf
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="district_en" id="addCategoryEN" value="{{ $districts->district_en }}" lenght="25">
                                        ...
                                        <input type="text" class="form-control" name="district_hun" id="addCategoryHU" value="{{ $districts->district_hun }}" lenght="25">
                                        @error('category_hun')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror

                                        <div class="justify-content-md-end">
                                            <button type="submit" class="btn btn-xl btn-primary mt-3 me-md-2 mt-5" style="float:right;">Update district</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
