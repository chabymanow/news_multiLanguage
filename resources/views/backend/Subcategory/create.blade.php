                            ...
                            <div class="mb-8">
                                ...
                                @csrf
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="subcategory_en" id="addCategoryEN" lenght="25">
                                        ...
                                        <input type="text" class="form-control" name="subcategory_hun" id="addCategoryHU" lenght="25">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="category_id" id="category">
                                                ...
                                                @foreach ($categories as $item)
                                                    <option value="{{ $item->id }}">{{ $item->category_en }} | {{ $item->category_hun }}</option>
                                                @endforeach
                                            </select>
                                            @error('category_id')
                                            <span class="text-danger">{{ $message }}</span>
